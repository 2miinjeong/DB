...
try:
    ...
    for item in series_seasons:
        ...
        for episode in episodes_list:
            ...
            sql = "INSERT INTO EPISODE (EPISODE_ID, SEASON_NAME, EPISODE_NUM, EPISODE_NAME, EPISODE_OVERVIEW, EPISODE_AIR_DATE, EPISODE_RTM, EPISODE_STILL) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
